...
int KRecorderSocketStreamRecord::IsAlive()
{
    ...
    nOperationResult = m_piSocketStream->IsAlive();

    SocketIsAlive.uType             = ertSocketIsAlive;
    SocketIsAlive.nOperationResult  = (int8_t)nOperationResult;

    m_piRecorder->Push(&SocketIsAlive, sizeof(SocketIsAlive));
