...
#define MAX_DAILY_QUEST_COUNT	20
#define MAX_ASSIST_QUEST_COUNT	64
...
#ifdef _SERVER
    BOOL                RegisterTeamAssistance(DWORD dwQuestID);
#endif
	BOOL				GetQuestRepeatCutPercent(KQuestInfo* pQuestInfo, int* pnRepeatCutPercent);
    BOOL				GetQuestLevelCutPercent(KQuestInfo* pQuestInfo, int* pnLevelCutPercent);
...
private:
    ...
    void                RegisterQuestAssistInfo(DWORD dwPlayerID, DWORD dwQuestID);
#endif
