...
BOOL KPlayerServer::DoPlayerDisplayData(DWORD dwPlayerID, DWORD dwCheckSum, int nConnIndex)
{
    ...
    PlayerDisplayData.uDisplayFlag            = pPlayer->m_Designation.m_bBynameDisplay;
    ...
    case trWhisper:
        {
            ...
            pTalkMsg->wSize = (WORD)uPakSize;
            pTalkMsg->byTalkData[0] = false; // ��ʾ�Ƿ�Echo��Ϣ
...
BOOL KPlayerServer::DoNpcTalkToPlayer(KNpc* pNpc, DWORD dwDialogID, NPC_TALK_ACTION_TYPE eTalkActionType, DWORD dwTalkIndex, CHARACTER_TALK_TYPE eTalkType, KTarget& rTarget)
{
	...
	case trNearby:
		...
		BroadcastFunc.m_nRange          = CELL_LENGTH * 2 * 12; // �߻�ָ����Χ
...
BOOL KPlayerServer::DoSyncRoleDataSectionCheckRequest(int nConnIndex, BYTE bySectionType)
{
    BOOL bResult = false;
    BOOL bRetCode = false;
    struct S2C_SYNC_ROLE_DATA_SECTION_CHECK_REQUEST
    {
        WORD byProtocolID;
        BYTE bySectionType;
    } Notify;
...
void KPlayerServer::OnClientConfirmReady(char* pData, size_t nSize, int nConnIndex, int nFrame)
{
    ...
    KGLOG_PROCESS_ERROR(pPlayer->OnExtDataLoadFinish());
Exit0:
    return;
}
...
void KPlayerServer::OnMountKungfu(char* pData, size_t nSize, int nConnIndex, int nFrame)
{
    ...
    // ����pOldMountKungfuΪ�����������̣�ʹ��֮ǰ����ע��!

    if (pPak->dwID == INVALID_SKILL_ID) // �����ж���ڹ�����
    {
        int nDuration = 0;

        KGLOG_PROCESS_ERROR(pOldMountKungfu); // û���ڹ���ʱ��ж���ڹ����ǲ����ܵġ�
...
void KPlayerServer::OnTeamSetLootMode(char* pData, size_t nSize, int nConnIndex, int nFrame)
{
    ...
    KGLOG_PROCESS_ERROR(pPlayer->m_dwID == pTeam->dwAuthority[tatDistribute]); //ֻ�з����߲����޸ķ���ģʽ
    ...
    case trFriends:
        {
            ...
            pEchoMsg->byTalkData[0] = true; // ��ʾ�Ƿ�Echo��Ϣ
...
void KPlayerServer::OnSendMailRequest(char* pData, size_t nSize, int nConnIndex, int nFrame)
{
    ...
    if (pPlayer->m_bFreeLimitFlag)                                  // �շ���Ҳ������ʼ�����
    {
    ...
    KGLOG_PROCESS_ERROR(pRequest->wTextLen > 0); // ���ַ���Ҳ��1���ֽ�
    KGLOG_PROCESS_ERROR(pRequest->wTextLen <= MAX_MAIL_TEXT_LEN);
    pRequest->szText[pRequest->wTextLen - 1] = '\0';

    if (STR_CASE_CMP(pPlayer->m_szName, pRequest->szDstName) == 0)  // ���ܸ��Լ����ʼ�
    {
...
void KPlayerServer::OnAuctionSellRequest(char* pData, size_t nSize, int nConnIndex, int nFrame)
{
    ...
    // ���㱣�ܷ�(����۵�40% ÿ12Сʱ)�����ܷ�����10ͭ��С��10ͭ����10ͭ
...
void KPlayerServer::OnCreateViewPointRequest(char* pData, size_t nSize, int nConnIndex, int nFrame)
{
    ...
    KGLOG_PROCESS_ERROR(pPlayer->m_ViewPoint.pRegion == NULL);  // ��ǰ�޹۲��
    ...
    pPlayer->RegisterViewObjectByViewPoint(NULL, pRegion);     // ��pRegion��Ķ���ע�ᵽplayerͬ���б���
