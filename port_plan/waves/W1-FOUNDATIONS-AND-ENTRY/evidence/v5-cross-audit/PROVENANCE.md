...
- Query executable: `graphengine/tools/query/journey_contract_query.py`; V5 adapter mode produces `journey-contract-query/v5`; its blind target-static path currently labels its output schema `journey-contract-query/v4`.
