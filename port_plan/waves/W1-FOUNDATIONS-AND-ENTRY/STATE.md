...
- Read next: `entry/ENTRY_STATIC_DOSSIER.md`, `compare-engine/docs/compare-engine-operational-guide.md`, and the card `port_plan/waves/W1-FOUNDATIONS-AND-ENTRY/cards/PLY-ENTER-WORLD.md`.
