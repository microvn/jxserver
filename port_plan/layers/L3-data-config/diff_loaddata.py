...
SRC = os.environ.get("SOURCE_CPP", str(ROOT / "src/SO3World/Src/KGWConstList.cpp"))
SRCH = os.environ.get("SOURCE_HEADER", str(ROOT / "src/SO3World/Src/KGWConstList.h"))
if not EXE or not PROJ:
    raise SystemExit("set TARGET_BINARY and GHIDRA_PROJECT before running diff_loaddata.py")
