#!/usr/bin/env python3
"""Generate PORT_MAP.csv from a normalized symbol-analysis work directory.

Usage: generate_method_inventory.py --input-dir <work-dir> [--out <port-plan-dir>]
"""
import argparse
import csv
import json
...
PARSER.add_argument("--input-dir", type=Path, required=True,
                    help="directory containing per_class_full.tsv, v25_sig_map.tsv and missing_full.tsv")
PARSER.add_argument("--out", type=Path, default=Path(__file__).resolve().parents[2],
                    help="port_plan output directory (default: parent of layers/)")
ARGS = PARSER.parse_args()
SP = ARGS.input_dir.resolve()
