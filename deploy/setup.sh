...
# ----------------------------------------------------------------------------
# The source tree (src/ include/ compat/) is git-tracked and is the
...
# patches. That one-off pipeline is frozen into the baseline commit; endgame.py's
# edits are baked into source.
# ============================================================================
set -euo pipefail
