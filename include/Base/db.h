 ...
 *
 * $Id: db.h,v 1.1 2006/11/13 10:32:53 wufanghao Exp $
 *
...
typedef enum {
	...
	DB_RECNO=3,
	DB_QUEUE=4,
	DB_UNKNOWN_=5			/* Figure it out on open. */
} DB_TYPE;					/* DB_UNKNOWN, DBTYPE is conflicting used in "oledb.h" */
...
struct __db {
	...
	DB_TYPE	 type;			/* DB access method type. */
