...
enum C2B_PROTOCOL_ID    // Client ==> Bishop
{
    ...
    C2B_QUERY_ROLE_LIST_IN_ZONE,// 请求大区角色列表
...
#define LOGIN_R_PASSPOD_USED                28 // 令牌已使用
#define LOGIN_R_PASSPOD_FAILED              29 // 验证失败
#define LOGIN_R_PASSPOD_EXPIRED             30 // 令牌过期
#define LOGIN_R_PASSPOD_NOTFOUND            31 // 令牌绑定未找到
#define LOGIN_R_PASSPOD_DISABLE             32 // 令牌已经禁用（挂失）

// 该帐号为防沉迷对象且没填实名信息
#define LOGIN_R_LIMIT_ACCOUNT_BY_EMPTYINFO	33
