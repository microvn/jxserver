...
ENGINE_API	BOOL	g_GetFilePathFromFullPath(char* lpPathName, const char* lpFullFilePath);
ENGINE_API	void	g_GetRelativePath(char* lpRelativePathName, const char* lpFilePath);
