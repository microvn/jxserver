...
//	转帐结果
enum _Transfer_Result
{
	_TRANSFER_SUCCESS		= 1,			// 转帐成功
	_TRANSFER_FAIL			= 2,			// 转帐失败
	_TRANSFER_ACCOUTERROR	= 3,			// 帐号找不到
	_TRANSFER_NOTCOIN		= 1100			// 金币余额不足
};
...
//	冻结结果
typedef	enum _Freeze_Result
{
	_FREEZE_SUCCESS		= 1,			// 转帐成功
	_FREEZE_FAIL		= 2,			// 转帐失败
	_FREEZE__NOTCOIN	= 1100			// 金币余额不足
};
